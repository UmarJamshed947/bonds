...
import 'package:bonds/Models/Search_Bond.dart';
import 'package:bonds/Views/Rangesearch_Results.dart';
import 'package:bonds/Views/Search_Result.dart';
            ...
            MaterialButton(
              ...
              onPressed: () async {
                if (selectedRadio == 0) {
                  ...
                  String prizeBondTypeUid = selectedDate.toString();
                  String prizeBond = _randomRangeController.text.trim();
                  if (prizeBond.isNotEmpty) {
                    // Call the searchdata function
                    List<SearchBond> searchResults = await searchdata(prizeBondTypeUid, selectedDrawUid!, prizeBond);
